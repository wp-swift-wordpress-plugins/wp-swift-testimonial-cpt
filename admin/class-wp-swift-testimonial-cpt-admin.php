 ...
 * @subpackage Wp_Swift_Testimonial_Cpt/admin
 */
 ...
 */
class Wp_Swift_Testimonial_Cpt_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-swift-testimonial-cpt-admin.js', array( 'jquery' ), $this->version, false );
